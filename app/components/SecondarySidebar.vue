...
onMounted(() => {
  const offcanvas = new $bootstrap.Offcanvas(document.getElementById("secondarySidebar")!);
  watch(
    () => route.fullPath,
    async (fullPath) => {
...
<template>
  <div class="offcanvas offcanvas-end" tabindex="-1" id="secondarySidebar">

    <div class="offcanvas-header">
      <h5 class="offcanvas-title">Arquivos</h5>
      <button type="button" class="btn-close" data-bs-dismiss="secondarySidebar"></button>
    </div>
